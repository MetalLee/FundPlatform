...
function ScrollBar({
  ...
  return (
    <ScrollAreaPrimitive.Scrollbar
      ...
      className={cn(
        "flex touch-none p-px opacity-0 transition-opacity select-none group-hover/scroll-area:opacity-100 data-horizontal:h-1.5 data-horizontal:flex-col data-horizontal:border-t data-horizontal:border-t-transparent data-vertical:h-full data-vertical:w-1.5 data-vertical:border-l data-vertical:border-l-transparent",
        className
      )}
      {...props}
    >
